...
{
		$sql ="UPDATE customer SET  `customer_name`='$_POST[customername]', `address`='$_POST[address]', `state_id`='$_POST[state]', `city_id`='$_POST[city]', `pincode`='$_POST[pincode]', `contact_no`='$_POST[cntctnum]', `email_id`='$_POST[email_id]',  `customer_type`='$_POST[customertype]', `status`='$_POST[status]' WHERE customer_id='$_SESSION[customerid]'";
...
<hr>
<div class="text-center">
	<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg px-5 " >Click Here to Update Profile</button>
</div>
</form>
            </div>
		  </div>
