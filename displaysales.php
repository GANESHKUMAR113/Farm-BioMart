...
?></select></span>
        ...
        <input type="submit" name="submit" id="submit" value="Search" class="btn btn-info my-2"> <br>
...
?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="imgproduct/<?php echo $rs['img_1']; ?>" class="img-fluid" alt="" style="width: 100px;height: 100px;">
