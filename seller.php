...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		$sql ="UPDATE seller SET seller_name='$_POST[sellername]', seller_address='$_POST[selleraddress]', state_id='$_POST[state]',  city_id='$_POST[city]', pincode='$_POST[pincode]', contact_number='$_POST[contactnumber]', email_id='$_POST[emailid]', password='$_POST[password]', bank_name='$_POST[bankname]', bank_branch='$_POST[branch]', bank_IFSC='$_POST[ifsccode]', bank_acno='$_POST[bankacnumber]', status='$_POST[status]' WHERE seller_id='$_GET[editid]'";
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id,  city_id, pincode, contact_number, email_id, password, bank_name, bank_branch, bank_IFSC, bank_acno, status) VALUES ('$_POST[sellername]','$_POST[selleraddress]','$_POST[state]','$_POST[city]','$_POST[pincode]','$_POST[contactnumber]','$_POST[emailid]','$_POST[password]','$_POST[bankname]','$_POST[branch]','$_POST[ifsccode]','$_POST[bankacnumber]','Active')";	
	if(!mysqli_query($con,$sql))
		{
      ...
      function validatesellreg()
	  {
		  ...
		  if(document.frmsellreg.sellername.value == "")
			...
			else if(!document.frmsellreg.emailid.value.match(emailExp))
			{
		  	...
		  	else if(document.frmsellreg.password.value.length < 5)
			{
