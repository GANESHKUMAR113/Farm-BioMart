...
if(isset($_POST['submit']))
{
	...
	if(isset($_GET['editid']))
	{
		...
		$sql = $sql . " quantity='$_POST[quantity]', quantity_type='$_POST[quantitytype]', uploaded_date='$_POST[uploaddate]', status='' WHERE product_id='$_GET[editid]'";
...
$sql = $sql . " , quantity, quantity_type, uploaded_date, status) VALUES ('$_SESSION[sellerid]','$_POST[category]','$_POST[produce]','$_POST[title]','$imgname1'";
...
if(!mysqli_query($con,$sql))
	...
	else
	{
		...
		{
		echo "<script>alert('Your Product has not been put on sale..');</script>";
		}
	}
}
}
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Enter Product Details...</h4></center><hr>
...
sfunction loadstatus(prodstatus)
{
