...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE article SET `article_type`='$_POST[articletype]', `publish_date`='$_POST[publishdate]', `title`='$_POST[title]', `article_description`='" .  mysqli_real_escape_string($con,$_POST['description']) . "', `article_img1`='$imgname1',`status`='$_POST[status]' where article_id='$_GET[editid]'";
	...
	$sql="INSERT INTO `article`(`article_type`, `publish_date`, `title`, `article_description`, `article_img1`, `status`) VALUES ('$_POST[articletype]','$_POST[publishdate]','$_POST[title]','$description','$imgname1','Active')";
	if(!mysqli_query($con,$sql))
		{
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Enter Article Details...</h4></center><hr>
